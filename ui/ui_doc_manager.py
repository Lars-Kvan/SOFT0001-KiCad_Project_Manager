...
from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QTreeView, QListView,
                             ...
                             QLineEdit, QFrame, QScrollArea, QFileDialog, QComboBox, QToolButton)
...
class DocumentManagerTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.lbl_path = QLabel(f"Location: {self.root_path}")
        self.lbl_path.setStyleSheet("font-weight: bold; color: #555;")
        if theme in ["Dark"]:
             self.lbl_path.setStyleSheet("font-weight: bold; color: #AAA;")

...
class ValidationTab(QWidget):
    ...
    def setup_rules_ui(self, parent):
        ...
        # Metrics Dashboard
        dash_box = QGroupBox("Validation Metrics")
        ...
        header_layout.addWidget(dash_box, 3)
        ...
        btn_run.setStyleSheet("font-weight: bold; background-color: #1565C0; color: white; height: 30px;")
        ...
        header_layout.addWidget(ctrl_box, 2)
    ...
    def setup_dupe_ui(self, parent):
        ...
        btn_scan = QPushButton("Scan for Duplicate MPNs")
    ...
    def setup_fp_check_ui(self, parent):
        ...
        h_layout = QHBoxLayout()
        btn_scan = QPushButton("Verify Footprint Pinouts")
        btn_scan.setIcon(Icons.get_icon(Icons.SEARCH, icon_color))
        btn_scan.setFixedWidth(200)
    ...
    def setup_exemption_ui(self, parent):
        layout = QVBoxLayout(parent)
        header = QHBoxLayout()
        header.addWidget(QLabel("<b>Active Exemptions (Rule Ignores)</b>"))
    ...
    def _create_metric(self, layout, label, value, color="black"):
        ...
        val_lbl.setStyleSheet("font-size: 24px; font-weight: bold; background: transparent;")
        l.addWidget(val_lbl)
        
        txt_lbl = QLabel(label)
        txt_lbl.setAlignment(Qt.AlignCenter)
        txt_lbl.setStyleSheet("background: transparent; font-size: 14px;")
        l.addWidget(txt_lbl)

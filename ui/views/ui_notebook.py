...
class NotebookTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.empty_pages = EmptyState(
            "No pages yet",
            "Create a page to start taking notes.",
            Icons.DOCUMENTS,
            "New Page",
            self.new_page,
            icon_color,
        )
        self.tree_stack.addWidget(self.empty_pages)
        l_layout.addWidget(self.tree_stack)
    ...
    def refresh_list(self):
        ...
        if self.tree.topLevelItemCount() == 0:
            self.tree_stack.setCurrentWidget(self.empty_pages)
        else:
            self.tree_stack.setCurrentWidget(self.tree)
